...
<body>
    ...
    <header>
        <div class="title_bar">
            ...
            <br>
            <h1 id="website_name">PS Library Management System - &nbsp; <i class="fa-solid fa-pen-to-square"></i> Update Book Page</h1>
        </div>
        <nav>
            <ul>
                ...
                <a href="./update-book.php"><li id="active_tab"><i class="fa-solid fa-pen-to-square"></i>UPDATE BOOK</li></a>
    ...
    <!-- Insert All HTML codes for Update Book Page Under this comment -->
