...
<body>
    ...
    <header>
        <div class="title_bar">
            ...
            <br>
            <h1 id="website_name">PS Library Management System - &nbsp; <i class="fa-sharp fa-solid fa-trash"></i> Delete Book Page</h1>
        </div>
        <nav>
            <ul>
                ...
                <a href="./delete-book.php"><li id="active_tab"><i class="fa-sharp fa-solid fa-trash"></i>DELETE BOOK</li></a>
            </ul>
        </nav>
    </header>
    <!-- Do Not Touch Header, Formality Purposes -->
