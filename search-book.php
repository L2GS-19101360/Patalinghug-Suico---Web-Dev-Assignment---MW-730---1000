...
<body>
    ...
    <header>
        <div class="title_bar">
            ...
            <br>
            <h1 id="website_name">PS Library Management System - &nbsp; <i class="fa-solid fa-magnifying-glass"></i> Search Book Page</h1>
        </div>
        <nav>
            <ul>
                ...
                <a href="./search-book.php"><li id="active_tab"><i class="fa-solid fa-magnifying-glass"></i>SEARCH BOOK</li></a>
